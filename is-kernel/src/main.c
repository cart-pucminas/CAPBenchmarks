...
/* Problem sizes. */
static struct problem tiny        = {  16777216 };
static struct problem small       = {  33554432 };
static struct problem workstation = {  67108864 };
static struct problem standard    = { 134217728 };
static struct problem large       = { 268435456 };
