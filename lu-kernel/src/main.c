...
/* Problem sizes. */
static struct problem tiny        =  {  128,  128 };
static struct problem small       =  {  256,  256 };
static struct problem workstation =  {  512,  512 };
static struct problem standard    =  { 1024, 1024 };
